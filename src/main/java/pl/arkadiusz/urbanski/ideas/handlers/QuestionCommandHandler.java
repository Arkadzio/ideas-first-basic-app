...
public class QuestionCommandHandler extends BaseCommandHandler {
  ...
  public QuestionCommandHandler() {
    this.questionDao = new GenericDao<>("./src/main/resources/questions.txt", new TypeReference<>() {
    });
    this.categoryDao = new GenericDao<>("./src/main/resources/categories.txt", new TypeReference<>() {
    });
  }
